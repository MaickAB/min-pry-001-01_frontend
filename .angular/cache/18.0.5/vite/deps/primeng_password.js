  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function Password_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("ngClass", ɵɵpipeBind2(1, 25, ctx.toggleMask, ctx.containerClass))("ngStyle", ctx.style);
        ɵɵattribute("data-pc-name", "password")("data-pc-section", "root");
        ɵɵadvance(2);
        ɵɵclassMap(ctx.inputStyleClass);
        ɵɵproperty("ngClass", ɵɵpipeBind2(4, 28, ctx.disabled, ctx.inputFieldClass))("ngStyle", ctx.inputStyle)("value", ctx.value)("variant", ctx.variant)("autofocus", ctx.autofocus);
        ɵɵattribute("label", ctx.label)("aria-label", ctx.ariaLabel)("aria-labelledBy", ctx.ariaLabelledBy)("id", ctx.inputId)("type", ɵɵpipeBind2(5, 31, ctx.unmasked, ctx.inputType))("placeholder", ctx.placeholder)("autocomplete", ctx.autocomplete)("maxlength", ctx.maxLength)("data-pc-section", "input");
        ɵɵadvance(4);
